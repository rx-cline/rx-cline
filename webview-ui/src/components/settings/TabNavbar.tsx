		...
		<>
			<div
				...
				<VSCodeButton
					...
					onClick={onPlusClick}
					style={buttonStyle}
					onMouseEnter={(e) => showTooltip("新会话", e, "center")}
					onMouseLeave={hideTooltip}
					onMouseMove={(e) => showTooltip("新会话", e, "center")}>
				...
				<VSCodeButton
					...
					style={buttonStyle}
					onMouseEnter={(e) => showTooltip("历史", e, "center")}
					onMouseLeave={hideTooltip}
					onMouseMove={(e) => showTooltip("历史", e, "center")}>
